...
public class StatisticsLog {
	...
	private final static String castID = "1432791";// 必选：统计曝光时，投放ID
	private final static String cityID = null;// 可选时，必须为null:统计曝光时，某地域的城市ID,指定统计某地区的详细IP对应的曝光量。进一步判断这些Ip对应的extIP是多少，即实际投放在哪个地区

	private final static String ideaID = "820560";// 可选时，必须为null：统计容量时，素材ID
